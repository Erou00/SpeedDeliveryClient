...
const CommandeDeafultCard = ({item,handleCardPress,deleteCommande}) => {
  ...
  return (
    <TouchableOpacity style={styles.card} onPress={()=>handleCardPress(item)}>
        ...
        <View style={styles.cardHeader}>
            ...
            <Text style={styles.price}>DD MAD</Text>
            </View>
        </View>

        <View style={styles.desc}>
            <Text style={styles.textDesc}>ddd</Text>
        </View>
...
export default CommandeDeafultCard